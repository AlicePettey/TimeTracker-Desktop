...
const store = new Store({
  ...
  defaults: {
    ...
    settings: {
      ...
      syncUrl: 'https://mfkvbauiirxvrsgkiztz.supabase.co',          // https://xxxxx.supabase.co
      syncToken: '',        // desktop sync token generated by web app
      syncAnonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1ma3ZiYXVpaXJ4dnJzZ2tpenR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjY5MzUxNTAsImV4cCI6MjA4MjUxMTE1MH0.2H-8kPyZ1GVSBbvF8Ua8if1cdGTQSrTVTZm_PnPROEw',      // SUPABASE ANON KEY fallback for packaged app
